...
const WORKS = [
  ...
  /* 10 ───────── 山嗨驚（大三專題） ───────── */
  {
    ...
    category: "遊戲 · 大三專題",
    cover: "",
    video: "assets/videos/第五組錄製內容PART1.mp4",  // 遊戲實錄；之後若有截圖可加 images 陣列
    images: [],
    intro: "大三專題遊戲作品。遊戲選單有四個選項：劇情模式、遊戲玩法、快速遊玩、離開遊戲。劇情模式以角色對話形式呈現劇情；並使用 Unity 的 Edgar for Unity 隨機地圖插件，讓每次遊玩都能體驗不同地圖，增加可玩性。",
    tools: "Unity、C++、Word",
