  ...
  groups: [
    {
      ...
      items: [
        { title: "樂扣樂扣 掀蓋款 Fun 飲杯", video: "assets/videos/shopee-1.mp4", url: "https://tw.shp.ee/1tnprjvv?smtt=0.0.9", thumb: "assets/images/shopee-1.jpg", result: "2–6 月帶動售出 55 支水壺" },
...
const WORKS = [
  /* ───────── 山嗨驚（畢業專題，置頂） ───────── */
  {
    ...
    award: "2025 畢業專題比賽展覽 — 特優第一名、人氣第一名"
  },
